...
class Item {
	...
	/**
	 * Adds the game type defined in the string. Does nothing if no game type is found.
	 * @param gT
	 */
	...
	/**
	 * Adds the restriction named in the string. Does nothing if no restriction is found.
	 * @param r
